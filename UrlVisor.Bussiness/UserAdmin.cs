...
namespace UrlVisor.Bussiness
{
    public class UserAdmin : IUserAdmin
    {
        ...
        {
            if (string.IsNullOrEmpty(user)) throw new LogInException("Debe completar el nombre de usuario");
            if (string.IsNullOrEmpty(pass)) throw new LogInException("Debe completar la contraseña");
        ...
        public UserAdmin(UsuarioRepositoryBase usuarioRepository)
        {
